...
$(function() {
    ...
    $('.group-name a').attr('href', '/public/html/group/group-detail/index.html?group-id=' + getRequestParams.get('group-id'));
...
function addMessage(element) {
    ...
    tempMessageDom.find('p.name').text(element['nickname']);
